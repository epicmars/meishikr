...
import com.meishikr.app.view.widget.ViewConfig.TouchMode;
...
public class SlideLayout extends ViewGroup {
     ...
     */
    public static final int STATE_IDLE = TouchMode.TOUCH_MODE_IDLE;
    /**
     * 表示slide处于按下动作，即表示触控操作的开始
     */
    public static final int STATE_DOWN = TouchMode.TOUCH_MODE_DOWN;
    /**
     * 表示slide处于长按状态
     */
    public static final int STATE_LONG_PRESS = TouchMode.TOUCH_MODE_LONG_PRESS;
    /**
     * 表示slide正被用户拖拽
     */
    public static final int STATE_DRAGGING = TouchMode.TOUCH_MODE_DRAGGING;
    /**
     * 表示slide正设置到一个最终的位置，如向左滑动距离超过右边slide的一半后，释放动作，那么右边slide将会被完全打开
     */
    public static final int STATE_SETTLING = TouchMode.TOUCH_MODE_SETTLING;
    // attr
